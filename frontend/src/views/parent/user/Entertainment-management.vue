<template>
    <div>
        ...
        <el-table :data="activities" border style="width: 100%"
            ...
            <el-table-column label="报名人数" prop="registrationCount">
            </el-table-column>
            <el-table-column label="报名时间" prop="registrationTime">
            </el-table-column>
...
export default {
    ...
    methods: {
        fetchFormData() {
            this.activity.studentId=this.student.id;
            queryOne(this.activity,"activityRegistration").then(res => {
