<template>
    <div>
        <div class="search">
            <el-form :data="course" class="form-search">
                <el-form-item label="科目："><el-input placeholder="请输入科目查询" style="width: 200px"
                        v-model="course.name"></el-input></el-form-item>
                <el-form-item label="教师："><el-input placeholder="请输入教师名称查询" style="width: 200px"
                        v-model="course.courseTeacherName"></el-input></el-form-item>
        ...
        <div class="table">
            <el-table :data="courses" strip @selection-change="handleSelectionChange">
                ...
                <el-table-column label="封面">
                    <template v-slot="scope">
                        <el-image :src="scope.row.picture"
                            style="width: 50px; height: 30px; border-radius: 5px"></el-image>
                    </template>
                </el-table-column>
                <el-table-column prop="location" label="地点"></el-table-column>
                <el-table-column prop="teacherId" label="教师编号"></el-table-column>
                <el-table-column prop="courseTeacherName" label="教师名称"></el-table-column>
        ...
        <el-dialog title="修改或添加信息" :visible.sync="dialogFormVisible">
            <el-form :model="form" label-width="100px">
                ...
                <el-form-item label="开课时间" prop="time">
                    <el-input type="date" v-model="form.time"></el-input>
                </el-form-item>
                <el-form-item label="地点" prop="location">
                    <el-input v-model="form.location"></el-input>
                </el-form-item>
                <el-form-item label="教师编号" prop="teacherId">
                    <el-input :disabled="true" v-model="form.teacherId"></el-input>
                </el-form-item>
                <el-form-item label="教师姓名" prop="courseTeacherName">
                    <el-select placeholder="请选择教师" v-model="form.courseTeacherName" @change="handleTeacherChange">
                        <el-option v-for="teacher in teachers" :key="teacher.value" :label="teacher.label"
                            :value="teacher.value">
                        </el-option>
                    </el-select>
                </el-form-item>
...
export default {
    ...
    methods: {
        ...
        save() {
            if (!(this.form.id === 0)) {
                updateOne(this.form, 'course').then(res => {
                ...
                addOne(this.form, 'course').then(res => {
                    if (res.code === 20000) {
        ...
        delBatch() {   // 批量删除
            ...
            this.$confirm('您确定批量删除这些数据吗？', '确认删除', { type: "warning" }).then(response => {
                ...
                this.$request.delete('/course/deleteBatch', { data: this.ids }).then(res => {
                    if (res.code === 20000) {   // 表示操作成功
                        this.$message.success('操作成功')
                        this.fetchFormData();
                    } else {
        ...
        reset() {
            ...
            this.course.courseTeacherName = null
            this.fetchFormData()
        },
        find() {
            console.log(this.course)
            queryOne(this.course, 'course').then(res => {
                this.courses = res.data;
            })
        }
    }
